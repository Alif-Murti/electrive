...
<?php 
	...
	{
		$nama = $_POST['email'];
		$komentar = $_POST['isi_pesan']; 
        $date = $_POST['tanggal'];
			  
		$tambahuser = mysqli_query($conn,"insert into saran values('','$email','$isi_pesan','$tanggal')");
		if ($tambahuser){
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from pesan order by id_pesan ASC");
											$id_pesan=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <td><a href="mailto:<?php echo $p['email'] ?>" target="_blank" class="btn btn-primary">Balas</a></td>
                                                    <td><a class="btn btn-danger" href="delete.php?id_pesan=<?php echo $p['id_pesan']; ?>">Delete</a></td>
												</tr>		
