...
<html lang="en">
  <head>
        <?php
      $profile=mysqli_query($conn,"SELECT * from mobil where id_mbl='$id_mbl'");
    ...
    />
    <title>Electrive - Mobil <?php echo $p['tipe_mbl'] ?></title>
  </head>
  <body>
    <!-- navbar -->
    <div>
        ...
        <div class="col-xl-6">
            ...
            <div class="card-body">
              <h5 class="card-title">INFORMASI MOBIL</h5>
               <table style="width:100%">
                <tr>
                  <th>Tipe Mobil :</th>
                  <td><h5><?php echo $p['tipe_mbl'] ?></h5></td>
                 </tr>
                <tr>
                  <th>Merek Mobil :</th>
                  <td><h5><?php echo $p['merek_mbl'] ?></h5></td>
                </tr>
                <tr>
                  <th>Kapasitas Tangki Bensin :</th>
                  <td><h5><?php echo $p['kapasitas_mbl'] ?></h5></td>
                </tr>
                <tr>
                ...
                <tr>
                  <th>Daya :</th>
                  <td><h5><?php echo $p['daya_mbl'] ?></h5></td>
                </tr>
                <tr>
                  <th>Torsi :</th>
                  <td><h5><?php echo $p['torsi_mbl'] ?></h5></td>
                </tr>
                <tr>
                  <th>Harga Mobil :</th>
          ...
          <div class="mt-3">
            <div class="card-body">
              ...
              <p class="card-text"><p><?php echo $p['desk_mbl'] ?></p></p>
            </div>
          </div>
        </div>
        <?php
    ...
    <div class="bg-dark mb-n4 mt-5">
      <div class="text-center">
        ...
        <p class="text-light mt-n2">
          Copyright ©2022 All rights reserved | This website is made by LazyDino
        </p>
      </div>
    </div>
    <!-- footer -->
