...
<html lang="en">
  ...
  <body>
    <div>
      ...
      <div>
        <img
          src="../img/frontend/banner_motor.png"
      ...
      <div class="mx-5 mx-md-banner mt-5">
        <div class="input-group mb-3">
          <input
          placeholder="Cari Motor Yang Kamu Suka"
          id="searchbar"
          name="search"
          onkeyup="search_motorlistrik()"
            type="text"
            class="form-control"
      ...
      <div class="mx-5 my-5">
        <div class="row justify-content-start gx-3">
           <?php
              $profile=mysqli_query($conn,"SELECT * from motor");
    ...
    ></script>
    <script>
      function search_motorlistrik() {
    let input = document.getElementById('searchbar').value
    input=input.toLowerCase();
    let x = document.getElementsByClassName('motor_listrik');
