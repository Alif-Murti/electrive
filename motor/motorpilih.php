...
<html lang="en">
  <head>
        <?php
      $profile=mysqli_query($conn,"SELECT * from motor where id_mtr='$id_mtr'");
    ...
    />
    <title>Electrive - Motor <?php echo $p['tipe_mtr'] ?></title>
  </head>
  <body>
    <!-- navbar -->
    <div>
      ...
      <div class="row gx-5">
        ...
        <div class="col-xl-6">
          <div class="card mt-4 mt-lg-0">
            <div class="card-body">
              <h5 class="card-title">INFORMASI MOTOR</h5>
               <table style="width:100%">
                <tr>
                  <th>Tipe Motor :</th>
                  <td><h5><?php echo $p['tipe_mtr'] ?></h5></td>
                 </tr>
                <tr>
                  <th>Merek Motor :</th>
                  <td><h5><?php echo $p['merek_mtr'] ?></h5></td>
                </tr>
                <tr>
                  <th>Kapasitas Baterai :</th>
                  <td><h5><?php echo $p['baterai_mtr'] ?></h5></td>
                </tr>
                <tr>
                  <th>Kecepatan Maksimal :</th>
                  <td><h5><?php echo $p['maks_mtr'] ?></h5></td>
                </tr>
                <tr>
                  <th>Jarak Tempuh :</th>
                  <td><h5><?php echo $p['jt_mtr'] ?></h5></td>
                </tr>
                <tr>
                  <th>Harga Motor :</th>
          ...
          <div class="mt-3">
            <div class="card-body">
              <h5 class="card-title">Deskripsi Motor</h5>
