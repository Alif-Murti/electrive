...
<html lang="en">
  <head>
        <?php
      $profile=mysqli_query($conn,"SELECT * from jasa where id_jasa='$id_jasa'");
    ...
    />
    <title>Electrive - Jasa <?php echo $p['nama_jasa'] ?></title>
  </head>
  <body>
    <!-- navbar -->
    <div>
      ...
      <div class="row gx-5">
        ...
        <div class="col-xl-6">
          <div class="card mt-4 mt-lg-0">
            <div class="card-body">
              <h5 class="card-title">INFORMASI JASA</h5>
               <table style="width:100%">
                <tr>
                  <th>Nama Jasa :</th>
                  <td><h5><?php echo $p['nama_jasa'] ?></h5></td>
                 </tr>
                <tr>
                  <th>Penyedia :</th>
                  <td><h5><?php echo $p['penyedia_jasa'] ?></h5></td>
                </tr>
                <tr>
                  <th>Alamat Bengkel / Workshop :</th>
                  <td><h5><?php echo $p['alamat_jasa'] ?></h5></td>
                </tr>
                <tr>
                  <th>No Telp :</th>
                  <td><h5><?php echo $p['kontak_jasa'] ?></h5></td>
                </tr>
              </table>
            </div>
          </div>
