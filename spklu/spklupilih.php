...
<html lang="en">
  <head>
        <?php
      $profile=mysqli_query($conn,"SELECT * from spklu where id_spklu='$id_spklu'");
    ...
    />
    <title>Electrive - Charging Station <?php echo $p['nama_spklu'] ?></title>
  </head>
  <body>
    <!-- navbar -->
    <div>
      ...
      <div class="gmap_canvas">
        ...
        <div class="col-xl-6">
          <div class="card mt-4 mt-lg-0">
            <div class="card-body">
              <h5 class="card-title mb-3">INFORMASI CHARGING STATION</h5>
               <table style="width:100%">
                <tr>
                  <th>Nama :</th>
                  <td><h5><?php echo $p['nama_spklu'] ?></h5></td>
                 </tr>
                <tr>
                  <th>Kota</th>
                  <td><h5><?php echo $p['kota'] ?></h5></td>
                </tr>
              </table>
            </div>
          </div>
          <div class="mt-3">
            <div class="card-body">
              ...
              <p class="card-text"><p><?php echo $p['alamat'] ?></p></p>
            </div>
          </div>
        </div>
        <?php
